...
*/
use curv::BigInt;
use curv::elliptic::curves::secp256_k1_wasm::GE;
use curv::elliptic::curves::secp256_k1_wasm::FE;
...
pub struct Proof {
    ...
    pub elgamal_enc: Vec<HomoELGamalProof<curv::elliptic::curves::secp256_k1_wasm::GE>>,
    pub elgamal_enc_dlog: HomoELGamalDlogProof<curv::elliptic::curves::secp256_k1_wasm::GE>,
}
...
impl Proof {
    pub fn prove(
        w: &Witness,
        c: &Helgamalsegmented,
        G: &curv::elliptic::curves::secp256_k1_wasm::GE,
        Y: &curv::elliptic::curves::secp256_k1_wasm::GE,
        segment_size: &usize,
    ) -> Proof {
        // bulletproofs:
